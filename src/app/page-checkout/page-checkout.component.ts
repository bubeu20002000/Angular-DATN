...
export class PageCheckoutComponent implements OnInit {
  ...
  constructor(private datePipe: DatePipe, private cartService: CartService, private formBuilder: FormBuilder, private funtions: FunctionsService, private token: TokenStorageService) {
